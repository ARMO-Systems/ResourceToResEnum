...
"%ProgramFiles(x86)%\MSBuild\12.0\Bin\MSBuild.exe" Source\Main.sln /p:Configuration="%config%" /p:Platform="x86" /m /v:M /fl /flp:LogFile=msbuild.log;Verbosity=Normal /nr:false
